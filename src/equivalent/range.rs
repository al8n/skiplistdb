use self::iter::WriteTransactionAllVersions;
...
/// An iterator over a subset of entries of the database.
pub struct WriteTransactionRange<'a, Q, R, K, V, S>
where
  K: Ord + Borrow<Q>,
  R: RangeBounds<Q> + 'a,
  Q: Ord + ?Sized,
...
impl<'a, Q, R, K, V, S> WriteTransactionRange<'a, Q, R, K, V, S>
where
...
impl<'a, Q, R, K, V, S> Iterator for WriteTransactionRange<'a, Q, R, K, V, S>
where
  K: core::hash::Hash + Eq + Ord + Borrow<Q> + 'static,
  Q: Ord + ?Sized,
  R: RangeBounds<Q> + 'a,
...
impl<'a, Q, R, K, V, S> DoubleEndedIterator for WriteTransactionRange<'a, Q, R, K, V, S>
where
  K: core::hash::Hash + Eq + Ord + Borrow<Q> + 'static,
  Q: Ord + ?Sized,
  R: RangeBounds<Q> + 'a,
...
/// An iterator over a subset of entries of the database.
pub struct WriteTransactionAllVersionsRange<'a, Q, R, K, V, S>
where
  K: Ord + Borrow<Q>,
  R: RangeBounds<Q> + 'a,
  Q: Ord + ?Sized,
...
impl<'a, Q, R, K, V, S> WriteTransactionAllVersionsRange<'a, Q, R, K, V, S>
where
  K: core::hash::Hash + Eq + Ord + Borrow<Q> + 'static,
  Q: Ord + ?Sized,
  R: RangeBounds<Q> + 'a,
